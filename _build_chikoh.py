...
write(
    ...
    page(
        ...
        "Tsavo safari",
        '<a href="index.html">Home</a> <span>/</span> Chikoh <span>/</span> Packages',
        "Packages we run",
...
write(
    ...
    page(
        ...
        '<a href="index.html">Home</a> <span>/</span> Chikoh <span>/</span> Activities',
        "Activities to do",
...
write(
    ...
    page(
        ...
        '<a href="index.html">Home</a> <span>/</span> Chikoh <span>/</span> Lodges',
...
write(
    ...
    page(
        ...
        "Kenyan savanna",
        '<a href="index.html">Home</a> <span>/</span> Chikoh <span>/</span> Payment',
        "Payment information",
